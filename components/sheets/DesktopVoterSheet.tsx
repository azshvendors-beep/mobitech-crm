    ...
    <div className="lg:block hidden">
      <Sheet open={isOpen} onOpenChange={handleOpenChange}>
        <SheetTrigger asChild>
          <Button className="mt-4">{triggerText}</Button>
        </SheetTrigger>
        <SheetContent
          ...
          <Form {...form}>
            <form className="flex-1 flex flex-col">
              ...
              {currentStep === totalSteps && (
                <div className="bg-white p-4 border-t flex w-full justify-between items-center">
                  <Button
                    type="button"
                    variant="destructive"
                  ...
                  <Button
                    ...
                    className="flex items-center gap-1 h-12 w-1/4 bg-green-600 hover:bg-green-700"
                  >
                    Verify
                    <ChevronRight size={16} />
                  </Button>
